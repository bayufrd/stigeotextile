  ...
  return (
    <div className="contact-info p-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href={`tel:${addressData.phone.banten}`} className="bg-[#0A1E2B] p-4 rounded-2xl text-center shadow-lg flex flex-col items-center justify-center cursor-pointer hover:opacity-90 transition-opacity">
          <FaPhone className="w-6 h-6 mx-auto mb-2 text-white" />
        ...
        <Link href={`mailto:${addressData.email}`} className="bg-[#4A6B8C] p-4 rounded-2xl text-center shadow-lg flex flex-col items-center justify-center cursor-pointer hover:opacity-90 transition-opacity">
          <FaEnvelope className="w-6 h-6 mx-auto mb-2 text-[#0A1E2B]" />
          <p className="font-semibold text-[#0A1E2B]">CONTACT US</p>
          <p className="text-[#0A1E2B] text-center">{addressData.email}</p>
        </Link>
        <Link 
